...
TRAIN_JSON = '/opt/ml/input/data/stratified_group_kfold/train_fold0.json'
VAL_JSON = '/opt/ml/input/data/stratified_group_kfold/val_fold0.json'
...
def parse_args():
    ...
    parser.add_argument('--val_path', default=VAL_JSON, help='the path of val.json')
    parser.add_argument('--test_path', default=TEST_JSON, help='the path of test.json')
...
def create_mask(json_path, target_path):
    dataset = CustomDataset(data_dir=json_path, mode='train', transform=A.Compose([ToTensorV2()]))
