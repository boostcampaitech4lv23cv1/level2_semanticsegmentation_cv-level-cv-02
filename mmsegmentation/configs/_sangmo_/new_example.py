...
data = dict(
    ...
    train=dict(
        ...
        img_dir='/opt/ml/input/data/mmseg/images/training',
        ann_dir='/opt/ml/input/data/mmseg/annotations/training',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
            dict(type='Resize', img_scale=(512, 512), ratio_range=(0.5, 2.0)),
    ...
    val=dict(
        ...
        type='CustomDataset',
        reduce_zero_label=False,
        img_dir='/opt/ml/input/data/mmseg/images/validation',
        ann_dir='/opt/ml/input/data/mmseg/annotations/validation',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        ...
        type='CustomDataset',
        reduce_zero_label=False,
        img_dir='/opt/ml/input/data/mmseg/images/test',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
